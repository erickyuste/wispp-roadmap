...
import G9PhysicalW8Term4 from "../../subjects/science/g9/G9PhysicalW8Term4";
import G9CivicsW7to8T4 from "../../subjects/hass/g9/G9CivicsW7to8T4";
import G9TechW7to8Term4 from "../../subjects/technology/g9/G9TechW7to8Term4";
import G9MusicW7to8Term4 from "../../subjects/visual arts/g9/G9MusicW7to8Term4";
import G9HETerm4 from "../../subjects/healthEducation/g9/G9HETerm4";
import G9PEW8to10Term4 from "../../subjects/physicalEducation/g9/G9PEW8to10Term4";
...
function W8Term4() {
  ...
  const items = [
    ...
    },
    {
      ...
      content: <G9PhysicalW8Term4 />,
    },
    {
      id: "item4",
      label: "HaSS - Civics and Citizenship",
      content: <G9CivicsW7to8T4 />,
    },
    {
      id: "item5",
      label: "Technology -Digital",
      content: <G9TechW7to8Term4 />,
    },
    {
      id: "item6",
      label: "The Arts: Visual Arts",
      content: <G9MusicW7to8Term4 />,
    },
    {
      id: "item7",
      label:
