...
import G9PhysicalW10Term4 from "../../subjects/science/g9/G9PhysicalW10Term4";
...
function W10Term4() {
  ...
  const items = [
    ...
    },
    {
      ...
      content: <G9PhysicalW10Term4 />,
    },
    {
      id: "item4",
      label: "HaSS - Civics and Citizenship",
      content: <G9CivicsW9to10T4 />,
    },
    {
      id: "item5",
      label: "Technology - Digital",
      content: <G9TechW9to10Term4 />,
    },
    {
      id: "item6",
      label: "The Arts: Visual Arts",
      content: <G9MusicW9to10Term4 />,
    },
    {
      id: "item7",
      label:
