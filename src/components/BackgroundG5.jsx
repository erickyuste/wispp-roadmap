...
import BackgroundContentG5 from "./BackgroundContent/BackgroundContentG5";
import QuickLinksG5 from "./BackgroundContent/QuickLinksG5";
import dotted from "../assets/dotted.png";
import TimeAllocationG5 from "./BackgroundContent/TimeAllocationG5";

function BackgroundG5() {
  ...
  const items = [
    {
      id: "background",
      label: "Background",
      content: <BackgroundContentG5 />,
    },
    {
      id: "timeallocation",
      label: "Time Allocation",
      content: <TimeAllocationG5 />,
    },
    {
      id: "quicklinks",
      label: "WAC Quick Links",
      content: <QuickLinksG5 />,
    },
  ];
