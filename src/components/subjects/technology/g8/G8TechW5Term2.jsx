...
function G8TechW5Term2() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Use multi-branch selection (if, elif, else statements) to control
          the flow of program execution.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Describe how iteration (while statements) controls the flow of
          program execution.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1Po0DY7hk6brsM-fu-TspZHwJZyrEPbLd/view?usp=sharing"
              target="_blank"
          ...
          <button className="w-[7em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1gT26crJGRnMWSV1jXdCNKskVUm2dQt58/view?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
            >
              Resources
