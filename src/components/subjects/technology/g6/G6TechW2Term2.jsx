...
function G6TechW2Term2() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • This teaching and learning task provides students with an
          opportunity to review and consolidate learning about digital systems.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Students develop an understanding of, and experience with,
          diagrammatic representation of branching and iteration through a flow
          chart that illustrates a non-linear hyperlinked PowerPoint.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1IY20WFxf4YycwDNynsJYMAkuPVOfVEnD/view?usp=sharing"
              target="_blank"
