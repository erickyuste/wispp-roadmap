...
function G6TechW4Term1() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Students increase their understanding of the risks of using social
          media and exposure to potential bullying and exploitation. Students
          are able to have safe and positive experiences within digital
          environments.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1YYXlfKkaqxm1AfyXGt63jA1LmVThC0Lz/view?usp=sharing"
              target="_blank"
