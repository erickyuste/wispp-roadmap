...
function G6TechW3Term3() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Data can be obtained from primary or secondary data sources. Primary
          data is collected by the students themselves. Secondary data is
          collected from third-party sources.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Data is used to analyse a situation or problem. Interpretation of
          data refers to the reviewing of collected data to view patterns and
          trends, and with this knowledge, make assumptions about the data or
          future data.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1BuRabJNlbh-qb3qi7ivyRMO2Myx4q71m/view?usp=sharing"
              target="_blank"
