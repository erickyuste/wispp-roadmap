...
function G6TechW2Term1() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • When producing solutions, students are required to do so safely and
          they need to develop an understanding of options for communicating
          ideas and information.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Students experience how the same information can be communicated
          using different design solutions.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/16qgg4OJMEvkzpOD40Sbg7kGSm1qU9zkm/view?usp=sharing"
              target="_blank"
