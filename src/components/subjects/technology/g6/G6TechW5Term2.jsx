...
function G6TechW5Term2() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Computers code data using a binary system of counting. Students
          develop understanding that digital systems use whole numbers to
          represent various types of data, such as letters, numbers, images and
          sounds.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1003ltueyPrEwfg5NqKMlJwgExnRKkgwT/view?usp=sharing"
              target="_blank"
