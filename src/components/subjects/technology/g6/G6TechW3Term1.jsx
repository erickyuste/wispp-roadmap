...
function G6TechW3Term2() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Students understand social and ethical protocols for working
          collaboratively online. Students develop ways to manage online safety
          issues, such as inappropriate contact, cyberbullying, and the risks
          that can be involved in sharing images.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/13vKkObbkJUj3GittY7VZ5DyXhwn76Nn7/view?usp=sharing"
              target="_blank"
