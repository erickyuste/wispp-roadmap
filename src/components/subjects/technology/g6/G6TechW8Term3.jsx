...
function G6TechW8Term3() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Provide opportunities to develop knowledge, understanding and skills
          of visual programming to create a basic game. In particular,
          development of systems knowledge, and design and computational
          thinking are essential for students to experience. Creating digital
        ...
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1d30BnbsVj0gp7lr1c5D5x1k_C3NIJn8T/view?usp=sharing"
              target="_blank"
