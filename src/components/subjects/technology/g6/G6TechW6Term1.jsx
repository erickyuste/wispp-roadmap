...
function G6TechW6Term1() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Devices can be wired or wireless. Explain the interactions between
          components and basic functions in a digital system, and different ways
          that data can be transmitted to form networks.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1fFje_OK5WdhL9SKlQTGbkKAO_b5pEOX4/view?usp=sharing"
              target="_blank"
