...
function G6TechW7Term2() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Students understand and apply conversion of decimal numbers to
          binary, and binary to decimal, by creating a pathway in a grid
          framework. They write instructions, so others can follow the pathway.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/15yDgsejwr8bg9RBBpVGU39N1Cx3betrz/view?usp=sharing"
              target="_blank"
