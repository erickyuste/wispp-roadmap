...
function G6TechW5Term4() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • This summative task enabled students to apply the basics of computer
          programming and game design. Students used a flow chart to show a
          sequence of steps that illustrated the programming of the game. They
          applied their learning of visual programming software to create the
          game ready for a user.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1jdd3BVw6xtyNelbSbNO01uVwIJSb6d92/view?usp=sharing"
              target="_blank"
