...
function G6TechW4Term4() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Students design a game with a purpose (self-selected) and create a
          sequence of steps that will result in a usable game. The product
          includes branching and iteration, as well as user input, such as mouse
          movements or keyboard controls.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1Q0oLhjinYN6AH00VYxygSzPgvQYJvz0v/view?usp=sharing"
              target="_blank"
