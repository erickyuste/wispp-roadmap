...
function G6TechW5Term1() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Digital systems involve input of data through a range of
          peripherals, processing through computer hardware, such as central
          processing units and primary storage, and outputting information or
          data through output devices.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1FnzO-CmwgeS123R_yfg3odwW2-hD2F4Q/view?usp=sharing"
              target="_blank"
