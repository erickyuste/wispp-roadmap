...
function G6TechW6Term4() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Legal and ethical implications of copyright and plagiarism.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Students understand the implications of easy access to and use of
          digital media. It is easy to create, copy, remix, and share anything.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1j3C1_zRr9C_WB0CElR767GrjNQKQHz3o/view?usp=sharing"
              target="_blank"
