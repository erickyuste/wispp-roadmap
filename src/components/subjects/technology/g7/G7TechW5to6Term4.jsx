...
function G7TechW5to6Term4() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Develop the skills required to design simple two-way decisions
          (branching) and multi-way decisions. These skills will be required to
          create programs and develop flowcharts.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1fF8Mq-x9rpXYm3xnuclkeVWrSonLXCZm/view?usp=sharing"
              target="_blank"
...
export default G7TechW5to6Term4;
