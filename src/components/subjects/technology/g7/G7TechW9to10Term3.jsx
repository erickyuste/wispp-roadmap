...
function G7TechW9to10Term3() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Identify and physically connect networking devices in a small
          network. Explain the devices role, and the differences between wired
        ...
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/17aDpWCeslHsVP-zthfn3MIyhQ2PxL8uK/view?usp=sharing"
              target="_blank"
...
export default G7TechW9to10Term3;
