...
function G7TechW5to6Term2() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Students learn the movie-editing software skills to prepare them for
          the Stop motion movie or simple animation task (Appendix A), to be
          completed in Lessons 10–14.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1XUjUhRo6mfholbtMfxToIpCA1G1YGrjk/view?usp=sharing"
              target="_blank"
...
export default G7TechW5to6Term2;
