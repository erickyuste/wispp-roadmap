...
function G7TechW1to2Term3() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Define the role of hardware in a digital system. This hardware can
          include Central Processing Units (CPU), Random Access Memory (RAM) and
          Hard Disk Dive (HDD).
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/10giyvrqNzpDEMXOdC2CO3cRULyHid0ON/view?usp=sharing"
              target="_blank"
...
export default G7TechW1to2Term3;
