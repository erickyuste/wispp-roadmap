...
function G7TechW5to6Term3() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Identify and interpret transmissions speeds and the factors that
          affect transmission speeds.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Identify the differences between transmission speeds and bandwidth.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1ZvebZRC6CjtCe6giRt0BO8kCkOq4TwDk/view?usp=sharing"
              target="_blank"
...
export default G7TechW5to6Term3;
