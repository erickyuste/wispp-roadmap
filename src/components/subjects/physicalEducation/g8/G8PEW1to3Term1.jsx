  ...
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        ...
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • the importance of kicking, passing and controlling in a soccer
          context
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • the different types of kicking
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • how to control the ball when receiving a pass
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          To understand the assessment criteria and process used throughout
          lesson sequence
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/17BDV1LTIk9RrzEta7VJ1EHBGcgW9J7Rq/view?usp=sharing"
              target="_blank"
