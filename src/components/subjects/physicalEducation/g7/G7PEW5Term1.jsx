...
function G7PEW5Term1() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • To perform the skills of throwing and catching with consistency,
          efficiency, fluency and control in a game situation.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • To understand the importance of consistency, efficiency, fluency and
          control of throwing and catching in order to gain or regain
          possession.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1pI_T_UkcbE2nYvtHZGz-lg9MozHTvsm7/view?usp=sharing"
              target="_blank"
