...
function G7GeoW3Term2() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Use the PQE method to interpret and analyse a range of maps and/or
          data to identify and explain spatial distributions patterns and
          trends, and infer relationships about water resources.
        </p>
        <br></br>
