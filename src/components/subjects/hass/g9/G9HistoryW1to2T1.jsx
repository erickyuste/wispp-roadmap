...
function G9HistoryW1to2T1() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • The important features of the modern period (1750–1918) including
          technological change, Imperialism and Nationalism
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • The technological innovations that led to the Industrial Revolution,
          and other conditions that influenced the industrialisation of Britain
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/12CtLP5Axseh3Y53vDESyeYqZIrpFtkT_/view?usp=sharing"
              target="_blank"
...
export default G9HistoryW1to2T1;
