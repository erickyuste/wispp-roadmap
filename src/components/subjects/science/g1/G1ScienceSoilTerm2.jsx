...
function G1ScienceSoilTerm2() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • The focus of the teaching and learning is the external features of
          insects.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white">
          • Prepare non-fiction insect information.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white">
...
export default G1ScienceSoilTerm2;
