...
function G7EarthW5to6Term3() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Describe the major factors that influence seasons.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Consider how seasonal changes affect people in a variety of
          activities, such as farming.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Investigate how the position of the Earth in orbit/tilt of the Earth
          on its axis affects the seasons.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1fU26FbfcuQXjAnAhhrkHNDYLRfEPFrS2/view?usp=sharing"
              target="_blank"
...
export default G7EarthW5to6Term3;
