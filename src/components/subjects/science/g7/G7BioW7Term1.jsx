...
function G7BioW7Term1() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Recall the distinguishing characteristics of the five kingdoms.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Compare vertebrates and invertebrates and give examples of each.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Name the five groups of vertebrates.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Describe the main characteristics for each of the five main groups
          of Chordata.
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Classify familiar and unfamiliar organisms within the vertebrate
          group.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1NXxJNgHhnXkKLJXdQuIyoSicPBxaf7GK/view?usp=sharing"
              target="_blank"
