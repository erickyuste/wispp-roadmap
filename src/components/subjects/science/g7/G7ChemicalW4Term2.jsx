...
function G7ChemicalW4Term2() {
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Explain how centrifuging can be used to separate liquid mixtures or
          suspensions with components of different densities.
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/14UDskjErN7x0FSTo9dLZI_Yzv39E26nV/view?usp=sharing"
              target="_blank"
...
export default G7ChemicalW4Term2;
