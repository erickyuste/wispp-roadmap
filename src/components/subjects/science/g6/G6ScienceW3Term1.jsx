  ...
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        ...
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • What is the energy source within the circuit?
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • How are batteries used in everyday life?
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • What are the safety risks associated with using batteries?
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • How does energy transfer and transform into other forms of energy?
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1NsV9aCrjTkhJC6Me493bEduzm3uM8UiF/view?usp=sharing"
              target="_blank"
...
export default G6ScienceW3Term1;
