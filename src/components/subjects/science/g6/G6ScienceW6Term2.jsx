  ...
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        ...
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          Examples of independent variables (variables to change) may include:
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • brand of yeast
        </p>
        ...
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • addition of sugar in measured increments
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • type of sweetener (brown sugar, icing sugar, raw sugar, artificial
          sweetener).
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1GtV3u4lrhNjPR-H4HLkyVOipFw7ZDqxc/view?usp=sharing"
              target="_blank"
...
export default G6ScienceW6Term2;
