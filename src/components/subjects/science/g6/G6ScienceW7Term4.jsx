  ...
  return (
    <div>
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        ...
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • What are the physical changes that occur during rusting?
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • What are the chemical changes that occur during rusting?
        </p>
        <p className="font-semibold text-xs md:text-[16px] sm:text-sm text-white ">
          • Is rusting a reversible or irreversible process?
        </p>
        <br></br>
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1jxg2_Jb1C8Iw2YEaB2UlWNFStPgAXfaw/view?usp=sharing"
              target="_blank"
...
export default G6ScienceW7Term4;
