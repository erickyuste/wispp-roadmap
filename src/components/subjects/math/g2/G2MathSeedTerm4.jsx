      ...
      <div className="inner-content px-[.2rem] md:px-[1rem]">
        ...
        <div className="gap-2 mt-2 flex flex-wrap">
          <button className="w-[6em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://drive.google.com/file/d/1NgwrPMQc2lNNKGppG_FyeLdgAk3i6aA4/view?usp=sharing"
              target="_blank"
          ...
          <button className="w-[5em] h-[2em] rounded-xl text-xs md:text-sm text-white border-2 border-white font-bold hover:text-[#0582ca] hover:bg-white">
            <a
              href="https://docs.google.com/document/d/1zU8NaP2xVcN705YHtRfYBxsPeDlzQMyGmphNms2EOpA/edit?usp=sharing"
              target="_blank"
              rel="noopener noreferrer"
            >
              TFiles
...
export default G2MathSeedTerm4;
