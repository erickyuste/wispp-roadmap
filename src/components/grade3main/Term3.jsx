...
import W1Term3 from "../innerTerm3/g3/W1Term3";
import W2Term3 from "../innerTerm3/g3/W2Term3";
import W3Term3 from "../innerTerm3/g3/W3Term3";
import W4Term3 from "../innerTerm3/g3/W4Term3";
import W5Term3 from "../innerTerm3/g3/W5Term3";
import W6Term3 from "../innerTerm3/g3/W6Term3";
import W7Term3 from "../innerTerm3/g3/W7Term3";
import W8Term3 from "../innerTerm3/g3/W8Term3";
...
function Term3() {
  ...
  const items = [
    ...
    {
      id: "item7",
      label: "W7-8 (Feb 23-Mar 6)",
      content: <W7Term3 />,
    },
    {
      id: "item8",
      label: "W9-10 (Mar 9-20)",
      content: <W8Term3 />,
    },
  ];
      ...
      <div className="w-[95vw] flex justify-evenly items-center">
        ...
        <li className="flex items-center justify-center shadow-lg list-none w-[100%] rounded-lg bg-[#003554]">
          <h1 className="title flex gap-1 items-center justify-center py-2 font-bold text-xs sm:text-sm md:text-lg lg:text-xl text-gray-300 text-center cursor-pointer transition-transform duration-200 hover:scale-120">
            <a
              href="https://docs.google.com/spreadsheets/d/1LLVyZeHKTpWwxCQlk6xz9IH94XaVT-epwfYHCoutbSc/edit?usp=sharing"
              target="_blank"
            >
              TERM 3
            </a>
