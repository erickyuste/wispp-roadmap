...
import BackgroundContentG3 from "./BackgroundContent/BackgroundContentG3";
import QuickLinksG3 from "./BackgroundContent/QuickLinksG3";
import dotted from "../assets/dotted.png";
import TimeAllocationG3 from "./BackgroundContent/TimeAllocationG3";

function BackgroundG3() {
  ...
  const items = [
    {
      id: "background",
      label: "Background",
      content: <BackgroundContentG3 />,
    },
    {
      id: "timeallocation",
      label: "Time Allocation",
      content: <TimeAllocationG3 />,
    },
    {
      id: "quicklinks",
      label: "WAC Quick Links",
      content: <QuickLinksG3 />,
    },
  ];
