...
import W1Term3 from "../innerTerm3/g6/W1Term3";
import W2Term3 from "../innerTerm3/g6/W2Term3";
import W3Term3 from "../innerTerm3/g6/W3Term3";
import W4Term3 from "../innerTerm3/g6/W4Term3";
import W5Term3 from "../innerTerm3/g6/W5Term3";
import W6Term3 from "../innerTerm3/g6/W6Term3";
import W7Term3 from "../innerTerm3/g6/W7Term3";
import W8Term3 from "../innerTerm3/g6/W8Term3";
      ...
      <div className="w-[95vw] flex justify-evenly items-center">
        ...
        <li className="flex items-center justify-center shadow-lg list-none w-[100%] rounded-lg bg-[#003554]">
          <h1 className="title flex gap-1 items-center justify-center py-2 font-bold text-xs sm:text-sm md:text-lg lg:text-xl text-gray-300 text-center cursor-pointer transition-transform duration-200 hover:scale-120">
            <a
              href="https://docs.google.com/spreadsheets/d/1WzSdC9JUoc3D7eN6kUWneLOjOr2Dn3yEr4_hCr-kpfI/edit?usp=sharing"
              target="_blank"
            >
              TERM 3
            </a>
