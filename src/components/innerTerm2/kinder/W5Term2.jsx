...
import KLearningOutcomes2e from "../../subjects/kinder/KLearningOutcomes2e";
  ...
  const items = [
    {
      id: "item1",
      label:
        "(a) Developing an understanding of fairness and how to respond to unfairness",
      content: <KLearningOutcomes2e />,
    },
  ];
