...
import KLearningOutcomes2a from "../../subjects/kinder/KLearningOutcomes2a";
  ...
  const items = [
    {
      id: "item1",
      label:
        "(a) Developing skills for working with others and as active and informed citizens",
      content: <KLearningOutcomes2a />,
    },
  ];
