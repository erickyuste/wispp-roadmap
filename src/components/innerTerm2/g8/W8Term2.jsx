...
import G8ChemicalW8Term2 from "../../subjects/science/g8/G8ChemicalW8Term2";
import G8GeoW7to8T2 from "../../subjects/hass/g8/G8GeoW7to8T2";
import G8TechW8Term2 from "../../subjects/technology/g8/G8TechW8Term2";
import G8VisualW8Term2 from "../../subjects/visual arts/g8/G8VisualW8Term2";
...
function W8Term2() {
  ...
  const items = [
    ...
    },
    {
      ...
      content: <G8ChemicalW8Term2 />,
    },
    {
      id: "item4",
      label: "HaSS - Geography",
      content: <G8GeoW7to8T2 />,
    },
    {
      id: "item5",
      label: "Technology - Digital",
      content: <G8TechW8Term2 />,
    },
    {
      id: "item6",
      label: "The Arts: Visual Arts",
      content: <G8VisualW8Term2 />,
    },
    {
      id: "item7",
      label:
