...
import G8ChemicalW1to2Term2 from "../../subjects/science/g8/G8ChemicalW1to2Term2";
import G8GeoW1to4T2 from "../../subjects/hass/g8/G8GeoW1to4T2";
import G8TechW1to2Term2 from "../../subjects/technology/g8/G8TechW1to2Term2";
import G8VisualW1Term2 from "../../subjects/visual arts/g8/G8VisualW1Term2";
...
function W1Term3() {
  ...
  const items = [
    ...
    },
    {
      ...
      content: <G8ChemicalW1to2Term2 />,
    },
    {
      id: "item4",
      label: "HaSS - Geography",
      content: <G8GeoW1to4T2 />,
    },
    {
      id: "item5",
      label: "Technology - Digital",
      content: <G8TechW1to2Term2 />,
    },
    {
      id: "item6",
      label: "The Arts: Visual Arts",
      content: <G8VisualW1Term2 />,
    },
    {
      id: "item7",
      label:
