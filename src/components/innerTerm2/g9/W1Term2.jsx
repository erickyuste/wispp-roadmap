...
import G9ChemicalW1Term2 from "../../subjects/science/g9/G9ChemicalW1Term2";
import G9GeoW1to2T2 from "../../subjects/hass/g9/G9GeoW1to2T2";
import G9TechW1to2Term2 from "../../subjects/technology/g9/G9TechW1to2Term2";
import G9VisualW1to3Term2 from "../../subjects/visual arts/g9/G9VisualW1to3Term2";
import G9HETerm2 from "../../subjects/healthEducation/g9/G9HETerm2";
import G9PEW1to3Term2 from "../../subjects/physicalEducation/g9/G9PEW1to3Term2";
...
function W1Term3() {
  ...
  const items = [
    ...
    {
      id: "item3",
      label: "Science - Chemical (Atomic structure and radioactivity)",
      content: <G9ChemicalW1Term2 />,
    },
    {
      id: "item4",
      label: "HaSS - Geography",
      content: <G9GeoW1to2T2 />,
    },
    {
      id: "item5",
      label: "Technology - Digital",
      content: <G9TechW1to2Term2 />,
    },
    {
      id: "item6",
      label: "The Arts: Visual Arts",
      content: <G9VisualW1to3Term2 />,
    },
    {
      id: "item7",
      label:
