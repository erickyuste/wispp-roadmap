...
import W1Term4 from "../innerTerm4/g4/W1Term4";
import W2Term4 from "../innerTerm4/g4/W2Term4";
import W3Term4 from "../innerTerm4/g4/W3Term4";
import W4Term4 from "../innerTerm4/g4/W4Term4";
import W5Term4 from "../innerTerm4/g4/W5Term4";
import W6Term4 from "../innerTerm4/g4/W6Term4";
import W7Term4 from "../innerTerm4/g4/W7Term4";
import W8Term4 from "../innerTerm4/g4/W8Term4";
      ...
      <div className="w-[95vw] flex justify-evenly items-center">
        ...
        <li className="flex items-center justify-center shadow-lg list-none w-[100%] rounded-lg bg-[#003554]">
          <h1 className="title flex gap-1 items-center justify-center py-2 font-bold text-xs sm:text-sm md:text-lg lg:text-xl text-gray-300 text-center cursor-pointer transition-transform duration-200 hover:scale-120">
            <a
              href="https://docs.google.com/spreadsheets/d/1kw3PR9CALGhCgq3wg8m5fuzOScJddyUkQW3N-RyxoCM/edit?usp=sharing"
              target="_blank"
            >
              TERM 4
            </a>
