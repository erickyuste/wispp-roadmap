...
import BackgroundContentG7 from "./BackgroundContent/BackgroundContentG7";
import QuickLinksG7 from "./BackgroundContent/QuickLinksG7";
import dotted from "../assets/dotted.png";
import TimeAllocationG7 from "./BackgroundContent/TimeAllocationG7";

function BackgroundG7() {
  ...
  const items = [
    {
      id: "background",
      label: "Background",
      content: <BackgroundContentG7 />,
    },
    {
      id: "timeallocation",
      label: "Time Allocation",
      content: <TimeAllocationG7 />,
    },
    {
      id: "quicklinks",
      label: "WAC Quick Links",
      content: <QuickLinksG7 />,
    },
  ];
