...
import W1Term1 from "../innerTerm1/kinder/W1Term1";
import W2Term1 from "../innerTerm1/kinder/W2Term1";
import W3Term1 from "../innerTerm1/kinder/W3Term1";
import W4Term1 from "../innerTerm1/kinder/W4Term1";
import W5Term1 from "../innerTerm1/kinder/W5Term1";
import W6Term1 from "../innerTerm1/kinder/W6Term1";
import W7Term1 from "../innerTerm1/kinder/W7Term1";
import W8Term1 from "../innerTerm1/kinder/W8Term1";
import W9Term1 from "../innerTerm1/kinder/W9Term1";
...
function Term1() {
  ...
  const items = [
    {
      id: "item1",
      label: " W1 (Aug 11-15) - Learning Outcome 1: Identity",
      content: <W1Term1 />,
    },
    {
      id: "item2",
    ...
    {
      id: "item9",
      label: "W8 (Oct 6-10) : Continuation...",
      content: <W9Term1 />,
    },
  ];
