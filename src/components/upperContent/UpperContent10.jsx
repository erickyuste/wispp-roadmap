...
export default function UpperContent10() {
  const [openItem, setOpenItem] = useState(null);
  const quicklinkItem = data[11];
  ...
  const items = [
    {
      id: "background",
      label: "Background",
      content: <BackgroundContentG3to9 />,
    },
    {
      id: "timeallocation",
      label: "Time Allocation",
      content: <TimeAllocationG3to10 id={quicklinkItem.id} />,
    },
    {
      id: "quicklinks",
      ...
      content: (
        <QuickLinks
          judging={quicklinkItem.judging}
          exemplar={quicklinkItem.exemplar}
        />
      ),
    },
  ];
