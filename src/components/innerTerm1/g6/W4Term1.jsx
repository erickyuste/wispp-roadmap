...
import G6PEW4Term1 from "../../subjects/physicalEducation/g6/G6PEW4Term1";
  ...
  const items = [
    {
      id: "item1",
      label: "English",
      content: <G6EnglishW4Term1 />,
    },
    {
      id: "item2",
      label: "Math",
      content: <G6MathW4Term1 />,
    },
    {
      id: "item3",
      label: "Science (Physical sciences)",
      content: <G6ScienceW4Term1 />,
    },
    {
      id: "item4",
      label: "Humanities and Social Studies (Economics and Business)",
      content: <G6HassW4Term1 />,
    },
    {
      id: "item5",
      label: "Technology",
      content: <G6TechW4Term1 />,
    },
    {
      id: "item6",
      label: "The Arts: Drama (Exploring drama elements)",
      content: <G6DramaW4Term1 />,
    },
    {
      id: "item7",
      label: "The Arts: Music",
      content: <G6MusicW4Term1 />,
    },
    {
      id: "item8",
      label: "Health Education",
      content: <G6HealthW4Term1 />,
    },
    {
      id: "item9",
