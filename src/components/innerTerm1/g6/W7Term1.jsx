...
import G6HassW7Term1 from "../../subjects/hass/g6/G6HassW7Term1";
...
import G6PEW7Term1 from "../../subjects/physicalEducation/g6/G6PEW7Term1";
  ...
  const items = [
    {
      id: "item1",
      label: "English",
      content: <G6EnglishW7Term1 />,
    },
    {
      id: "item2",
      label: "Math",
      content: <G6MathW7Term1 />,
    },
    {
      id: "item3",
      label: "Science (Physical sciences)",
      content: <G6ScienceW7Term1 />,
    },
    {
      id: "item4",
      label: "Humanities and Social Studies (Economics and Business)",
      content: <G6HassW7Term1 />,
    },
    {
      id: "item5",
      label: "Technology",
      content: <G6TechW7Term1 />,
    },
    {
      id: "item6",
      label: "The Arts:Drama (Exploring drama elements)",
      content: <G6DramaW7Term1 />,
    },
    {
      id: "item7",
      label: "The Arts: Music",
      content: <G6MusicW7Term1 />,
    },
    {
      id: "item8",
      label: "Health Education",
      content: <G6HealthW7Term1 />,
    },
    {
      id: "item9",
