  ...
  const items = [
    {
      id: "item1",
      label: "English",
      content: <G6EnglishW8Term1 />,
    },
    {
      id: "item2",
      label: "Math",
      content: <G6MathW8Term1 />,
    },
    {
      id: "item3",
      label: "Science (Physical sciences)",
      content: <G6ScienceW8Term1 />,
    },
    {
      id: "item4",
      label: "Humanities and Social Studies (Economics and Business)",
      content: <G6HassW8Term1 />,
    },
    {
      id: "item5",
      label: "Technology",
      content: <G6TechW8Term1 />,
    },
    {
      id: "item6",
      label: "The Arts: Drama (Exploring drama elements)",
      content: <G6DramaW8Term1 />,
    },
    {
      id: "item7",
      label: "The Arts: Music",
      content: <G6MusicW8Term1 />,
    },
    {
      id: "item8",
      label: "Health Education",
      content: <G6HealthW8Term1 />,
    },
    {
      id: "item9",
