...
import G6HassW2Term1 from "../../subjects/hass/g6/G6HassW2Term1";
  ...
  const items = [
    {
      id: "item1",
      label: "English",
      content: <G6EnglishW2Term1 />,
    },
    {
      id: "item2",
      label: "Math",
      content: <G6MathW2Term1 />,
    },
    {
      id: "item3",
      label: "Science (Physical sciences)",
      content: <G6ScienceW2Term1 />,
    },
    {
      id: "item4",
      label: "Humanities and Social Studies (Economics and Business)",
      content: <G6HassW2Term1 />,
    },
    {
      id: "item5",
      label: "Technology",
      content: <G6TechW2Term1 />,
    },
    {
      id: "item6",
      label: "The Arts: Music",
      content: <G6MusicW2Term1 />,
    },
    {
      id: "item7",
      label: "The Arts: Drama (Exploring drama elements)",
      content: <G6DramaW2Term1 />,
    },
    {
      id: "item8",
      label: "Health Education",
      content: <G6HealthW2Term1 />,
    },
    {
      id: "item9",
