...
import G6HassW1Term1 from "../../subjects/hass/g6/G6HassW1Term1";
import G6TechW1Term1 from "../../subjects/technology/g6/G6TechW1Term1";
import G6DramaW1Term1 from "../../subjects/drama/g6/G6DramaW1Term1";
import G6MusicW1Term1 from "../../subjects/music/g6/G6MusicW1Term1";
import G6HealthW1Term1 from "../../subjects/healthEducation/g6/G6HealthW1Term1";
import G6PEW1Term1 from "../../subjects/physicalEducation/g6/G6PEW1Term1";
  ...
  const items = [
    {
      id: "item1",
      label: "English",
      content: <G6EnglishW1Term1 />,
    },
    {
      id: "item2",
      label: "Math",
      content: <G6MathW1Term1 />,
    },
    {
      id: "item3",
      label: "Science (Physical sciences)",
      content: <G6ScienceW1Term1 />,
    },
    {
      id: "item4",
      label: "Humanities and Social Studies (Economics and Business)",
      content: <G6HassW1Term1 />,
    },
    {
      id: "item5",
      label: "Technology",
      content: <G6TechW1Term1 />,
    },
    {
      id: "item6",
      label: "The Arts: Drama (Exploring drama elements)",
      content: <G6DramaW1Term1 />,
    },
    {
      id: "item7",
      label: "The Arts: Music",
      content: <G6MusicW1Term1 />,
    },
    {
      id: "item8",
      label: "Health Education",
      content: <G6HealthW1Term1 />,
    },
    {
      id: "item9",
