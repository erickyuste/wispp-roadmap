...
import G9BioW3to4Term1 from "../../subjects/science/g9/G9BioW3to4Term1";
import G9HistoryW3to4T1 from "../../subjects/hass/g9/G9HistoryW3to4T1";
import G9TechW3to4Term1 from "../../subjects/technology/g9/G9TechW3to4Term1";
...
function W3Term1() {
  ...
  const items = [
    ...
    },
    {
      id: "item4",
      label: "HaSS - History",
      content: <G9HistoryW3to4T1 />,
    },
    {
      id: "item5",
      label: "Technology - Digital",
      content: <G9TechW3to4Term1 />,
    },
    {
      id: "item6",
