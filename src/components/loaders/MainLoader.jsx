...
const MainLoader = () => {
  ...
  return (
    <div
      className={`fixed inset-0 z-100 flex h-screen w-full items-center justify-center bg-black overflow-hidden text-[3rem] transition-opacity duration-[5s] transition-visibility md:text-[5rem] ${
    ...
    >
      <svg viewBox="0 0 400 160" className="w-[20rem] font-bold">
        ...
        <text
          ...
          dx="1.5em"
          textAnchor="middle"
          className="fill-[#f6e9fe] stroke-[#f6e9fe] letter-spacing-[-6px]"
