...
import G2EnglishCanopyTerm3 from "../../subjects/english/g2/G2EnglishCanopyTerm3";
import G2MathCanopyTerm3 from "../../subjects/math/g2/G2MathCanopyTerm3";
import G2ScienceCanopyTerm3 from "../../subjects/science/g2/G2ScienceCanopyTerm3";
import G2HASSCanopyTerm3 from "../../subjects/hass/g2/G2HASSCanopyTerm3";
import G2TechnologyCanopyTerm3 from "../../subjects/technology/g2/G2TechnologyCanopyTerm3";
import G2VisualArtsCanopyTerm3 from "../../subjects/visual arts/g2/G2VisualArtsCanopyTerm3";
  ...
  const items = [
    {
      id: "item1",
      label: "English",
      content: <G2EnglishCanopyTerm3 />,
    },
    {
      id: "item2",
      label: "Math",
      content: <G2MathCanopyTerm3 />,
    },
    {
      id: "item3",
      label: "Science (Earth and Space Sciences)",
      content: <G2ScienceCanopyTerm3 />,
    },
    {
      id: "item4",
      label: "Humanities and Social Studies (History)",
      content: <G2HASSCanopyTerm3 />,
    },
    {
      id: "item5",
      label: "Technology (Digital and Design)",
      content: <G2TechnologyCanopyTerm3 />,
    },
    {
      id: "item6",
      label: "The Arts: Visual Arts",
      content: <G2VisualArtsCanopyTerm3 />,
    },
    {
      id: "item7",
      label: "The Arts: Music",
      content: <G2MusicCanopyTerm3 />,
    },
    {
      id: "item8",
      label: "Health Education",
      content: <G2HealthCanopyTerm3 />,
    },
    {
      id: "item9",
