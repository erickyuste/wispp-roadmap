...
import G8EarthW9to10Term3 from "../../subjects/science/g8/G8EarthW9to10Term3";
import G8EcoW9to10T3 from "../../subjects/hass/g8/G8EcoW9to10T3";
import G8TechW9to10Term3 from "../../subjects/technology/g8/G8TechW9to10Term3";
import G8MusicW9to10Term3 from "../../subjects/visual arts/g8/G8MusicW9to10Term3";
import G8HETerm3 from "../../subjects/healthEducation/g8/G8HETerm3";
import G8PEW8to10Term3 from "../../subjects/physicalEducation/g8/G8PEW8to10Term3";
...
function W10Term3() {
  ...
  const items = [
    ...
    {
      id: "item3",
      label: "Science - Earth and Space (Minerals and rock formation)",
      content: <G8EarthW9to10Term3 />,
    },
    {
      id: "item4",
      label: "HaSS - Economics and Business",
      content: <G8EcoW9to10T3 />,
    },
    {
      id: "item5",
      label: "Technology - Design",
      content: <G8TechW9to10Term3 />,
    },
    {
      id: "item6",
      label: "The Arts: Music",
      content: <G8MusicW9to10Term3 />,
    },
    {
      id: "item7",
      label:
