...
import BackgroundContentG4 from "./BackgroundContent/BackgroundContentG4";
import QuickLinksG4 from "./BackgroundContent/QuickLinksG4";
import dotted from "../assets/dotted.png";
import TimeAllocationG4 from "./BackgroundContent/TimeAllocationG4";

function BackgroundG4() {
  ...
  const items = [
    {
      id: "background",
      label: "Background",
      content: <BackgroundContentG4 />,
    },
    {
      id: "timeallocation",
      label: "Time Allocation",
      content: <TimeAllocationG4 />,
    },
    {
      id: "quicklinks",
      label: "WAC Quick Links",
      content: <QuickLinksG4 />,
    },
  ];
