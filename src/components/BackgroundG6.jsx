...
import BackgroundContentG6 from "./BackgroundContent/BackgroundContentG6";
import QuickLinksG6 from "./BackgroundContent/QuickLinksG6";
import dotted from "../assets/dotted.png";
import TimeAllocationG6 from "./BackgroundContent/TimeAllocationG6";

function BackgroundG6() {
  ...
  const items = [
    {
      id: "background",
      label: "Background",
      content: <BackgroundContentG6 />,
    },
    {
      id: "timeallocation",
      label: "Time Allocation",
      content: <TimeAllocationG6 />,
    },
    {
      id: "quicklinks",
      label: "WAC Quick Links",
      content: <QuickLinksG6 />,
    },
  ];
