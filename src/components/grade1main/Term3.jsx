...
import SoilTerm3 from "../innerTerm3/g1/SoilTerm3";
import SeedTerm3 from "../innerTerm3/g1/SeedTerm3";
import StalkTerm3 from "../innerTerm3/g1/StalkTerm3";
import FlowerTerm3 from "../innerTerm3/g1/FlowerTerm3";
import CanopyTerm3 from "../innerTerm3/g1/CanopyTerm3";
...
function Term3() {
  ...
  const items = [
    {
      id: "item1",
      label: "Soil W1-2 (Jan 12-23)",
      content: <SoilTerm3 />,
    },
    {
      id: "item2",
      label: "Seed W3-4 (Jan 26-Feb 6)",
      content: <SeedTerm3 />,
    },
    {
      id: "item3",
      label: "Stalk W5-6 (Feb 9-20)",
      content: <StalkTerm3 />,
    },
    {
      id: "item4",
      label: "Flower W7-8 (Feb 23-Mar 6)",
      content: <FlowerTerm3 />,
    },
    {
      id: "item5",
      label: "Canopy W9-10 (Mar 9-20)",
      content: <CanopyTerm3 />,
    },
  ];
      ...
      <div className="w-[95vw] flex justify-evenly items-center">
        ...
        <li className="flex items-center justify-center shadow-lg list-none w-[100%] rounded-lg bg-[#003554]">
          <h1 className="title flex gap-1 items-center justify-center py-2 font-bold text-xs sm:text-sm md:text-lg lg:text-xl text-gray-300 text-center cursor-pointer transition-transform duration-200 hover:scale-120">
            <a
              href="https://docs.google.com/spreadsheets/d/1ItYx53H4jyjqgMWhbXmKqotOeMWwGPj9MrEtFDuaHW0/edit?usp=sharing"
              target="_blank"
            >
              TERM 3
            </a>
