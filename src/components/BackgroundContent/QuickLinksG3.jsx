  ...
  return (
    <div>
      <div className="quicklinks-slide h-full w-full flex flex-wrap justify-evenly">
        ...
        >
          <a
            href="https://drive.google.com/drive/folders/12kLMuZ-Se2Rertrym4LXXVSZD79a6onv"
            target="_blank"
          >
            Judging Standards
          </a>
        ...
        >
          <a
            href="https://drive.google.com/drive/folders/1TEjcQI4bKO6RHYDECH98tXouZIgAXtzT"
            target="_blank"
          >
            Exemplar
          </a>
