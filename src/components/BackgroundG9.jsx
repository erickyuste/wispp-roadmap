...
import BackgroundContentG9 from "./BackgroundContent/BackgroundContentG9";
import QuickLinksG9 from "./BackgroundContent/QuickLinksG9";
import dotted from "../assets/dotted.png";
import TimeAllocationG9 from "./BackgroundContent/TimeAllocationG9";

function BackgroundG9() {
  ...
  const items = [
    {
      id: "background",
      label: "Background",
      content: <BackgroundContentG9 />,
    },
    {
      id: "timeallocation",
      label: "Time Allocation",
      content: <TimeAllocationG9 />,
    },
    {
      id: "quicklinks",
      label: "WAC Quick Links",
      content: <QuickLinksG9 />,
    },
  ];
